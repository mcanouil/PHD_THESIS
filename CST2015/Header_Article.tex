...
\lstset{ %
    ...
    basicstyle={\scriptsize\ttfamily\mdseries},         % the size of the fonts that are used for the code
	...
	\def\maketitle{
		...
		\begin{titlepage}
			\begin{center}
				...
				{\large{\@date}}
					\vskip 2cm
				{\includegraphics[height=60pt, keepaspectratio]{../UTILS/Logos/logo_cnrs.pdf} \hfill \includegraphics[height=60pt, keepaspectratio]{../UTILS/Logos/UL2-WEB-2014.png} \hfill \includegraphics[height=60pt, keepaspectratio]{../UTILS/Logos/Institut-Pasteur-de-Lille.png} \hfill \includegraphics[height=60pt, keepaspectratio]{../UTILS/Logos/logo_egid.pdf}}
			\end{center}
		\end{titlepage}
...
\newcommand{\R}{\protect\includegraphics[height=0.5cm, keepaspectratio]{../UTILS/Logos/logo_R.pdf}}
\newcommand{\Julia}{\protect{\raisebox{-0.5ex}{\includegraphics[height=0.5cm, keepaspectratio]{../UTILS/Logos/logo_julia.pdf}}}}