...
% pdflatex Poster_JAV2016.tex; bibtex Poster_JAV2016; pdflatex Poster_JAV2016.tex; pdflatex Poster_JAV2016.tex;
% evince Poster_JAV2016.pdf &
...
\begin{document}
\AddToShipoutPicture*{\AtPageLowerLeft{\transparent{0.20}\includegraphics[width=\paperwidth,height=\paperheight]{figures/BG01_A0.jpg}}}
...
% \columnbreak
\begin{center}
    \fbox{\includegraphics[width=0.8\linewidth]{/disks/DATA/DESIR_longitudinal/16-JointModel_MetaboChipSimu/JAV2016_Figure2.png}}
    \captionof{figure}{\textcolor{springgreen3}{Results from Joint Model (\cmd{JM}\ \citep{rizopoulos_jm_2010}).}}
    \label{Fig2}
\end{center}
...
\vspace{1cm}
\begin{center}
    \large{\input{"/disks/DATA/DESIR_longitudinal/16-JointModel_MetaboChipSimu/JAV2016_Table1.tex"}}
    \captionof{table}{\textcolor{springgreen3}{Parameter estimates from R package \cmd{JM} \citep{rizopoulos_jm_2010}.
    {In \textcolor{dodgerblue}{blue}: $\textrm{p-value}<0.05$, in \textcolor{firebrick2}{red}: $\textrm{p-value}<5\times 10^{-8}$. Power from the formula in \citet{chen_sample_2011}}}}
    \label{Tab1}
\end{center}
% \vspace{1cm}
...
% \vspace{-1cm}
\begin{center}
    \large{\input{"/disks/DATA/DESIR_longitudinal/16-JointModel_MetaboChipSimu/JAV2016_Table2.tex"}}
...
\bibliography{JAV2016.bib} % Use the example bibliography file sample.bib
\begin{center}
    \vfill
    {\includegraphics[height=6cm, keepaspectratio]{../UTILS/Logos/logo_cnrs.pdf}
    \hspace{11cm} \includegraphics[height=6cm, keepaspectratio]{../UTILS/Logos/UL2-WEB-2014.png}
    \hspace{8cm} \includegraphics[height=6cm, keepaspectratio]{../UTILS/Logos/Institut-Pasteur-de-Lille.png}
    \hspace{11cm} \includegraphics[height=6cm, keepaspectratio]{../UTILS/Logos/logo_egid.pdf}}
\end{center}
